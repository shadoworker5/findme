...
<head>
	...
	<style>
		.YKbuhtnZ {
			-webkit-animation: yFdRyA43 1.4s linear infinite;
			animation: yFdRyA43 1.4s linear infinite;
			background: conic-gradient(#fff 2%, #0e72ed);
			border-radius: 50%;
			height: 32px;
			position: relative;
			width: 32px
		...
		.JJBzkJ7V {
			background: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255, 0)), to(#0e72ed));
			background: linear-gradient(180deg, rgba(255, 255, 255, 0), #0e72ed)
		}

		.JJBzkJ7V:after {
			background: -webkit-gradient(linear, left bottom, left top, color-stop(10%, rgba(255, 255, 255, 0)), color-stop(30%, rgba(14, 113, 235, .5)), to(#0e72ed));
			background: linear-gradient(0deg, rgba(255, 255, 255, 0) 10%, rgba(14, 113, 235, .5) 30%, #0e72ed);
	...
	<style>
		...
		._8Wnjh6r:active,
		._8Wnjh6r:hover {
			background-color: rgba(82, 82, 128, .2)
		}
	...
	<style>
		.Yi1dda1y {
			...
			border-radius: 8px;
			-webkit-box-shadow: 0 2px 8px rgba(35, 35, 51, .1);
			box-shadow: 0 2px 8px rgba(35, 35, 51, .1);
			-webkit-box-sizing: border-box;
			box-sizing: border-box;
			color: #747487;
			padding: 12px 24px;
		...
		.EfOkLFMI {
			-webkit-animation: J7p9tSAc 1s;
			animation: J7p9tSAc 1s;
			right: 60px;
			top: 16px
		}
		...
		.WBC5Bo0Z {
			-webkit-animation: _xkzsXlw 1s;
			animation: _xkzsXlw 1s
		}
...
<body onload="information();">
		...
		<div id="header_outer" class="container clearfix">
			<div id="header" role="banner" class="clearfix">
				<a href="/" aria-label="Zoom Logo" class="imglink _OwMLWXp">
					<svg width="115" height="25" viewBox="0 0 90 20" fill="#2D8CFF" class="header-logo"
	...
	<div id="zoom-ui-frame" role="main" tabindex="0" class="JkSR_S4i">
		...
		<div class="inXzNydj">
			<div>
				<h1>Click <b>Open link</b> on the dialog shown by your browser<br>If you don’t see a dialog, click
					<b>Launch
						Meeting</b> below</h1>
				<h2 class="EOquiHKJ">By clicking "Launch Meeting", you agree to our <a terms="" tabindex="0"
						target="_blank" href="https://zoom.us/en-us/terms">Terms of Service</a> and <a privacy=""
						target="_blank" tabindex="0" href="https://zoom.us/en-us/privacy">Privacy Statement</a></h2>
				<a href="javascript:void(0);" onclick="locate();" target="" class="VahdFMz0">Launch Meeting</a>
				<hr>
				<h3 role="presentation">Don’t have Zoom Client installed? <a download="" tabindex="0">Download Now</a>
				</h3>
			</div>
		</div>
	</div>
